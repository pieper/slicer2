...
if { $::SLICER(versionInfo) != "" } {
    ...
    set SLICER(versionInfo) "$SLICER(versionInfo)  Version: $SLICER(version) CompilerName: ${compilerName} CompilerVersion: $compilerVersion ${libVersions} CVS: [ParseCVSInfo "" {$Id: Go.tcl,v 1.107.2.5 2006/02/16 16:37:15 hayes Exp $}] "
