...
<P> If <I>uncorrected p-values</I> is selected, the chosen threshold is applied to every voxel in the map and uncorrected p-values above the threshold are reported. This method is prone to report false positives, given the large number of voxels being tested.
