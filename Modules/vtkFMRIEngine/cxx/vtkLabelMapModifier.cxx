...
vtkStandardNewMacro(vtkLabelMapModifier);


vtkLabelMapModifier::vtkLabelMapModifier()
{
}
...
void vtkLabelMapModifier::SimpleExecute(vtkImageData *input, vtkImageData* output)
{
