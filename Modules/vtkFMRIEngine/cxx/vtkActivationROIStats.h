...
#ifndef __vtkActivationROIStats_h
#define __vtkActivationROIStats_h
...
class  VTK_FMRIENGINE_EXPORT vtkActivationROIStats : public vtkMultiInputsSimpleImageToImageFilter
{
public:
    static vtkActivationROIStats *New();
    vtkTypeMacro(vtkActivationROIStats, vtkMultiInputsSimpleImageToImageFilter);
