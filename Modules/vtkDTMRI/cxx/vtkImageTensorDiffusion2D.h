// .NAME vtkImageTensorDiffusion2D - Volumetric textures derived from
// tensor data.  
...
// is 0.
#ifndef __vtkImageTensorDiffusion2D_h
#define __vtkImageTensorDiffusion2D_h

#include "vtkDTMRIConfigure.h"
#include "vtkImageIterateFilter.h"
#include "vtkImageData.h"

class VTK_DTMRI_EXPORT vtkImageTensorDiffusion2D : public vtkImageIterateFilter
{
public:
  static vtkImageTensorDiffusion2D *New();
  vtkTypeMacro(vtkImageTensorDiffusion2D,vtkImageIterateFilter);
...
protected:
  vtkImageTensorDiffusion2D();
  ~vtkImageTensorDiffusion2D() {};
  vtkImageTensorDiffusion2D(const vtkImageTensorDiffusion2D&) {};
  void operator=(const vtkImageTensorDiffusion2D&) {};
