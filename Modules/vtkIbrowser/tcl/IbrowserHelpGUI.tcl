...
proc IbrowserBuildHelpFrame { } {
    ...
    #--- Help frame
    #-------------------------------------------
    set help " The <B> Ibrowser </B> provides a way to view time-series, multi-channel, 
...
<P> <B>Delete</B> lets you and delete sequences or collections. <P> 
...
intervals. <P> The Controller also has a set of animation controls, which 
...
The controller also provides a scrolled message box for system messages.<P> 
<B>Status:</B> This new tool is still being implemented; bug fixes, viewing and recording functions, 
processing options and the ability to load models, label maps and other data will be added 
in the future. Current known bugs exist in the canvas scrolling, animation controls, and slice visibility options.<P> "
