...
<P> <B>Hot images</B>: You may pick up any phase (except that for cold images) for hot images or just choose \"all\" on the list. If a specific phase is chosen, only one thermal volume will be computed. If \"all\" is selected, multiple thermal volumes will be computed, one for each phase (except for cold images).
<P> <B>Real images</B>: Just verify your real images. 
<P> <B>Imaginary images</B>: Just verify your imaginary images. 

<P> If button <I>Automatic</I> is checked, phase 1 will be automatically chosen for cold images and \"all\" selected for hot images if at least 3 phases are available within the experiment." 
