...
// 2) ITK_EXPORT -> VTK_MUTUALINFORMATIONREGISTRATION_EXPORT
// 3) addition of: #include "vtkMutualInformationRegistrationConfigure.h"
 ...
 */  
class VTK_MUTUALINFORMATIONREGISTRATION_EXPORT GradientDescentOptimizerWithStopCondition : 
