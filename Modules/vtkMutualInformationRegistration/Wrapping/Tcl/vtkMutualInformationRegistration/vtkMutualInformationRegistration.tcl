...
if {[info commands vtkMutualInformationRegistration] != "" ||
    [::vtk::load_component vtkMutualInformationRegistrationTCL] == ""} {
    global PACKAGE_DIR_VTKMutualInformationRegistration
    package provide vtkMutualInformationRegistration 1.0

    # source the Module's tcl file that contains it's init procedure
    source [file join $PACKAGE_DIR_VTKMutualInformationRegistration/../../../tcl/MutualInformationRegistration.tcl]
