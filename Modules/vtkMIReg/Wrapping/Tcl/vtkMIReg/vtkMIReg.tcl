...
if {[info commands vtkMIReg] != "" ||
    [::vtk::load_component vtkMIRegTCL] == ""} {
    global PACKAGE_DIR_VTKMIReg
    package provide vtkMIReg 1.0

    # source the Module's tcl file that contains it's init procedure
    source [file join $PACKAGE_DIR_VTKMIReg/../../../tcl/MIReg.tcl]
    ...
    global Module
    lappend Module(customModules) MIReg
}
