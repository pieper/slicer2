...
# Set the options for the warp
 ...
 #warpGeneralTransform SetInput Transform
      ...
      set DataType [[Transform GetDisplacementGrid] GetDataObjectType]
      puts " Transform displacementGrid, data type is $DataType"

      set {DIM_x DIM_y DIM_z} [[Transform GetDisplacementGrid] GetDimensions]

      puts " Transform displacementGrid, dimensions: $DIM_x $DIM_y $DIM_z"
      set {extent_1 extent_2 extent_3 extent_4 extent_5 extent_6} [[Transform GetDisplacementGrid] GetExtent]

      puts " Transform displacementGrid, extent: $extent_1  $extent_2 $extent_3 $extent_4 $extent_5 $extent_6"
    
      set ScalarSize [[Transform GetDisplacementGrid] GetScalarSize]
      puts " Transform displacementGrid, ScalarSize is $ScalarSize"

      set ScalarType [[Transform GetDisplacementGrid] GetScalarTypeAsString]
      puts " Transform displacementGrid, ScalarType is $ScalarType"
    
      set ScalarComponents [[Transform GetDisplacementGrid] GetNumberofScalarComponents]
