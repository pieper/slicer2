...
#    lappend Morphometrics(measurementInitTools) <an_init_function>
# and in <an_init_function> add
#    MorphometricsAddMeasurement <short_name> <workflow_name> <description>
# where
...
proc MorphometricsDeveloperMeasurementInit {} {
    ...
    MorphometricsAddMeasurement Example MorphometricsDeveloper "An example how to implement a morphometric tool"
}


lappend Morphometrics(measurementInitTools) MorphometricsDeveloperMeasurementInit
