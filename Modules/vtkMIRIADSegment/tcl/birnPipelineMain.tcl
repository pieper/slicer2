# eventually pieces of this can be abstracted out to make it more
# general

source [ file join $env(SCRIPT_HOME) tcl birnPipelineFunctions.tcl ]
source [ file join $env(SCRIPT_HOME) tcl NormalizeImage.tcl ]
