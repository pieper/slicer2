...
if {[info commands vtkMRProstateCare] != "" ||
    [::vtk::load_component vtkMRProstateCareTCL] == ""} {
    global PACKAGE_DIR_VTKMRProstateCare
    package provide vtkMRProstateCare 1.0

    # source the Module's tcl file that contains it's init procedure
    source [file join $PACKAGE_DIR_VTKMRProstateCare/../../../tcl/MRProstateCare.tcl]
    ...
    global Module
    lappend Module(customModules) MRProstateCare
}
