...
void HMatrixAlloc(HMatrix *A)
{
    int i;

    /*
       (*A)=(double**)mxCalloc(4,sizeof(double*));
       (*A)[0]=(double*)mxCalloc(16,sizeof(double));
     */

    (*A)=(double**)calloc(4,sizeof(double*));
    (*A)[0]=(double*)calloc(16,sizeof(double));
    ...
    for(i=1;i<4;i++) (*A)[i]=(*A)[i-1]+4;

}

void HMatrixFree(HMatrix A)
{
...
void do_rank1(HMatrix M, HMatrix Q)
{
    ...
    /*mat_copy(Q,=,mat_id,4);*/
    for(i=0;i<4;i++) for(j=0;j<4;j++) Q[i][j]=0;
    Q[0][0]=Q[1][1]=Q[2][2]=Q[3][3]=1.0;
...
HVect spect_decomp(HMatrix S, HMatrix U)
{
    ...
    /*mat_copy(U,=,mat_id,4);*/
    for(i=0;i<4;i++) for(j=0;j<4;j++) U[i][j]=0;
    U[0][0]=U[1][1]=U[2][2]=U[3][3]=1.0;
