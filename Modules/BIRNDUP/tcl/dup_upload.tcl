...
itcl::body dup_upload::constructor {args} {
    ...
    pack [button $f.upload -text "Sort" -command "$this upload"]
...
itcl::body dup_upload::setdeident {id method} {
    set _series($id,deident_method) $method
}

itcl::body dup_upload::view {id} {
