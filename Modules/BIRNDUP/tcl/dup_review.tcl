...
itcl::body dup_review::constructor {args} {
    ...
    pack [button $f.review -text "Sort" -command "$this review"]
...
itcl::body dup_review::setdeident {id method} {
    set _series($id,deident_method) $method
}

itcl::body dup_review::view {id} {
