...
#proc RunTest {{init 0}} {
#    global Path Volume Lut Module Model Volumes Slicer Slice exitCode Matrix
...
source [file join $::env(SLICER_HOME) Base/tcl/tcl-main/MainOptions.tcl]                
    ...
    MainUpdateMRML
###brauchst man das?
#set Module(ignoredList) {}
#set Module(supList) {Custom CrossSection}
#MainOptionsInit
#####
