...
class VTK_EXPORT vtkMRMLVolumeArchetypeStorageNode : public vtkMRMLStorageNode
{
  public:
 ...
 // Description:
  ...
  MRMLNodeSetStringMacro(FileArcheType);
  MRMLNodeGetStringMacro(FileArcheType, vtkMRMLVolumeArchetypeStorageNode);
