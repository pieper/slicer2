...
/************************************************************************/
void      cc_compute_exact_f_and_Tz_error (p,m_ptr, n_ptr, params, err)
    void *p;
    int  *m_ptr;        /* pointer to number of points to fit */
...
fprintf (stderr, "11FFFFFF %d\n", m);
  fprintf (stderr, "12FFFFFF %d\n", n);
  fprintf (stderr, "13FFFFFF %f\n", fvec[0]);
  fprintf (stderr, "14FFFFFF %f\n", fvec[1]);
  fprintf (stderr, "15FFFFFF %f\n", fvec[2]);
  fprintf (stderr, "16FFFFFF %f\n", fvec[3]);
  fprintf (stderr, "17FFFFFF %f\n", ftol);
  fprintf (stderr, "18FFFFFF %f\n", xtol);
  fprintf (stderr, "19FFFFFF %f\n", gtol);
  fprintf (stderr, "20FFFFFF %d\n", maxfev);
  fprintf (stderr, "21FFFFF %f\n", epsfcn);
  fprintf (stderr, "22FFFFFF %f\n", diag);
  fprintf (stderr, "23FFFFFF %d\n", mode);
  fprintf (stderr, "24FFFFFF %f\n", factor);
  fprintf (stderr, "25FFFFFF %d\n", nprint);
  fprintf (stderr, "26FFFFFF %d\n", info);
  fprintf (stderr, "27FFFFFF %d\n", nfev);
  fprintf (stderr, "28FFFFFF %f\n", fjac[0]);  
  fprintf (stderr, "29FFFFFF %d\n", fjac[1]);
  fprintf (stderr, "30FFFFFF %d\n", fjac[2]);
  fprintf (stderr, "31FFFFFF %d\n", fjac[3]);
  fprintf (stderr, "32FFFFFF %d\n", ldfjac);
  fprintf (stderr, "33FFFFFF %d\n", ipvt);
  fprintf (stderr, "34FFFFFF %f\n", qtf);
  fprintf (stderr, "35FFFFFF %f\n", wa1);
  fprintf (stderr, "36FFFFFF %f\n", wa2);
  fprintf (stderr, "37FFFFFF %f\n", wa3);
  fprintf (stderr, "38FFFFFF %f\n", wa4[0]);
  fprintf (stderr, "39FFFFFF %f\n", wa4[1]);
  fprintf (stderr, "40FFFFFF %f\n", wa4[2]);
  fprintf (stderr, "41FFFFFF %f\n", wa4[3]);
    fprintf(stderr,"cc_compute_exact_f_and_Tz: vor lmdif\n");
    /* perform the optimization */ 
//     lmdif (cc_compute_exact_f_and_Tz_error,
//             &m, &n, x, fvec, &ftol, &xtol, &gtol, &maxfev, &epsfcn,
//             diag, &mode, &factor, &nprint, &info, &nfev, fjac, &ldfjac,
//             ipvt, qtf, wa1, wa2, wa3, wa4);
 lmdif ((minpack_func_mn)cc_compute_exact_f_and_Tz_error, p,
            m, n, x, fvec, ftol, xtol, gtol, maxfev, epsfcn,
            diag, mode, factor, nprint,  &nfev, fjac, ldfjac,
            ipvt, qtf, wa1, wa2, wa3, wa4);
   fprintf(stderr,"cc_compute_exact_f_and_Tz: after lmdif\n");
 fprintf (stderr, "11FFFFFF %d\n", m);
  fprintf (stderr, "12FFFFFF %d\n", n);
  fprintf (stderr, "13FFFFFF %f\n", fvec[0]);
  fprintf (stderr, "14FFFFFF %f\n", fvec[1]);
...
/************************************************************************/
void      cc_five_parm_optimization_with_late_distortion_removal_error (p,m_ptr, n_ptr, params, err)
    void *p;
    int  *m_ptr;        /* pointer to number of points to fit */
    int  *n_ptr;        /* pointer to number of parameters */
    double *params;        /* vector of parameters */
...
fprintf(stderr,"cc_five_parm_optimization_with_late_distortion_removal: vor lmdif\n");
    /* perform the optimization */
    lmdif ((minpack_func_mn)cc_five_parm_optimization_with_late_distortion_removal_error,p,
            m, n, x, fvec, ftol, xtol, gtol, maxfev, epsfcn,
            diag, mode, factor, nprint,  &nfev, fjac, ldfjac,
            ipvt, qtf, wa1, wa2, wa3, wa4);
 fprintf(stderr,"cc_five_parm_optimization_with_late_distortion_removal: nach lmdif\n");
  fprintf (stderr, "2FFFFFF %f\n\n",cc.f);
...
/************************************************************************/
void      cc_five_parm_optimization_with_early_distortion_removal_error (p,m_ptr, n_ptr, params, err)
    void *p;
    int  *m_ptr;        /* pointer to number of points to fit */
    int  *n_ptr;        /* pointer to number of parameters */
    double *params;        /* vector of parameters */
...
fprintf(stderr,"after para set\n");
 ...
 fprintf(stderr,"mode\n");
 fprintf(stderr,"cc_five_parm_optimization_with_early_distortion_removal: vor lmdif\n");
    /* perform the optimization */
    lmdif ((minpack_func_mn)cc_five_parm_optimization_with_early_distortion_removal_error,p,
            m, n, x, fvec, ftol, xtol, gtol, maxfev, epsfcn,
            diag, mode, factor, nprint,  &nfev, fjac, ldfjac,
            ipvt, qtf, wa1, wa2, wa3, wa4);
 fprintf(stderr,"cc_five_parm_optimization_with_early_distortion_removal: nach lmdif\n");
fprintf(stderr,"optimate\n");
    /* update the calibration and camera constants */
    cc.f = x[0];
    cc.Tz = x[1];
    cc.kappa1 = x[2];
...
/************************************************************************/
void      cc_nic_optimization_error (p,m_ptr, n_ptr, params, err)
    void *p;
    int  *m_ptr;        /* pointer to number of points to fit */
    int  *n_ptr;        /* pointer to number of parameters */
    double *params;        /* vector of parameters */
...
void *p;
 ...
 fprintf(stderr,"cc_nic_optimization: vor lmdif\n");
    /* perform the optimization */
    lmdif ((minpack_func_mn)cc_nic_optimization_error,p,
            m, n, x, fvec, ftol, xtol, gtol, maxfev, epsfcn,
            diag, mode, factor, nprint, &nfev, fjac, ldfjac,
            ipvt, qtf, wa1, wa2, wa3, wa4);
fprintf(stderr,"cc_nic_optimization: nach lmdif\n");
    /* update the calibration and camera constants */
    cc.Rx = x[0];
    cc.Ry = x[1];
    cc.Rz = x[2];
...
/************************************************************************/
void      cc_full_optimization_error (p,m_ptr, n_ptr, params, err)
    void *p;
    int  *m_ptr;        /* pointer to number of points to fit */
    int  *n_ptr;        /* pointer to number of parameters */
    double *params;        /* vector of parameters */
...
fprintf(stderr,"cc_full_optimization: vor lmdif\n");
    /* perform the optimization */
    lmdif ((minpack_func_mn)cc_full_optimization_error,p,
            m, n, x, fvec, ftol, xtol, gtol, maxfev, epsfcn,
            diag, mode, factor, nprint, &nfev, fjac, ldfjac,
            ipvt, qtf, wa1, wa2, wa3, wa4);
fprintf(stderr,"cc_full_optimization: nach lmdif\n");
    /* update the calibration and camera constants */
    cc.Rx = x[0];
    cc.Ry = x[1];
    cc.Rz = x[2];
...
/************************************************************************/
void      ncc_compute_exact_f_and_Tz_error (p,m_ptr, n_ptr, params, err)
    void *p;
    int  *m_ptr;        /* pointer to number of points to fit */
    int  *n_ptr;        /* pointer to number of parameters */
    double *params;        /* vector of parameters */
...
void *p;
 ...
 fprintf(stderr,"ncc_compute_exact_f_and_Tz: vor lmdif\n");
    /* perform the optimization */
    lmdif ((minpack_func_mn)ncc_compute_exact_f_and_Tz_error,p,
            m, n, x, fvec, ftol, xtol, gtol, maxfev, epsfcn,
            diag, mode, factor, nprint, &nfev, fjac, ldfjac,
            ipvt, qtf, wa1, wa2, wa3, wa4);
fprintf(stderr,"ncc_compute_exact_f_and_Tz: nach lmdif\n");
    /* update the calibration constants */
    cc.f = x[0];
    cc.Tz = x[1];
    cc.kappa1 = x[2];
...
/************************************************************************/
void      ncc_nic_optimization_error (p,m_ptr, n_ptr, params, err)
    void *p;
    int  *m_ptr;        /* pointer to number of points to fit */
    int  *n_ptr;        /* pointer to number of parameters */
    double *params;        /* vector of parameters */
...
fprintf(stderr,"ncc_nic_optimization: vor lmdif\n");
    /* perform the optimization */
    lmdif ((minpack_func_mn)ncc_nic_optimization_error,p,
            m, n, x, fvec, ftol, xtol, gtol, maxfev, epsfcn,
            diag, mode, factor, nprint, &nfev, fjac, ldfjac,
            ipvt, qtf, wa1, wa2, wa3, wa4);
fprintf(stderr,"ncc_nic_optimization: nach lmdif\n");
    /* update the calibration and camera constants */
    cc.Rx = x[0];
    cc.Ry = x[1];
    cc.Rz = x[2];
...
/************************************************************************/
void      ncc_full_optimization_error (p,m_ptr, n_ptr, params, err)
    void *p;
    int  *m_ptr;        /* pointer to number of points to fit */
    int  *n_ptr;        /* pointer to number of parameters */
    double *params;        /* vector of parameters */
...
#define NPARAMS 11
 ...
 fprintf(stderr,"ncc_full_optimization: vor lmdif\n");
    /* perform the optimization */
    lmdif ((minpack_func_mn)ncc_full_optimization_error,p,
            m, n, x, fvec, ftol, xtol, gtol, maxfev, epsfcn,
            diag, mode, factor, nprint,  &nfev, fjac, ldfjac,
            ipvt, qtf, wa1, wa2, wa3, wa4);
fprintf(stderr,"ncc_full_optimization: nach lmdif\n");
    /* update the calibration and camera constants */
    cc.Rx = x[0];
    cc.Ry = x[1];
    cc.Rz = x[2];
