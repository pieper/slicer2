...
##
foreach var "VTK_ARG1 VTK_ARG2 VTK_ARG3 VTK_ARG4 VTK_ARG5 VTK_ARG6 VTK_ARG7 VTK_ARG8 VTK_ARG9 VTK_ARG_CONFIGURATIONS SLICER_ARG1 SLICER_ARG2 SLICER_ARG3 SLICER_ARG4 SLICER_ARG5 SLICER_ARG6 SLICER_ARG7 SLICER_ARG8 SLICER_ARG9 SLICER_ARG10 SLICER_ARG11 SLICER_ARG12" {
...
set SLICER_ARG9 "-DSLICER_LIB:PATH=$SLICER_LIB"
set SLICER_ARG10 "-DTEEM_SRC_DIR:PATH=$::TEEM_SRC_DIR"
set SLICER_ARG11 "-DTEEM_BIN_DIR:PATH=$::TEEM_BIN_DIR"
set SLICER_ARG12 "-DTEEM_BUILD_DIR:PATH=$::TEEM_BUILD_DIR"
...
foreach target $TARGETS {
    ...
    if { $NOCMAKEFLAG == 0 } {
        ...
        set cmakecmd [list $CMAKE $target -G$GENERATOR \
            ...
            $SLICER_ARG1 $SLICER_ARG2 $SLICER_ARG3 $SLICER_ARG4 $SLICER_ARG5 $SLICER_ARG6 $SLICER_ARG7 $SLICER_ARG8 $SLICER_ARG9 $SLICER_ARG10 $SLICER_ARG11 $SLICER_ARG12 $SLICER_EXECUTABLE $CTEST_SLICER_HOME $CTEST_XVNC_EXECUTABLE] 
